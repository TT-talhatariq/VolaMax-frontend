...
//         </label>
//       )}
//       <div className="flex items-center border-b border-gray-300 bg-transparent px-3 py-2 transition-all focus-within:border-[var(--brand-blue)]">
//         <input
//           className="flex-1 bg-transparent text-[#000000] font-[400] outline-none placeholder:text-gray-400"
//           {...props}
//         />
